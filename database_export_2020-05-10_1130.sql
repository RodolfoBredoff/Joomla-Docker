...
--
-- Host: mysql
-- Tempo de geração: 10/05/2020 às 14:30
...
--
-- Banco de dados: `jomladb`
--
CREATE DATABASE IF NOT EXISTS `jomladb` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `jomladb`;

-- --------------------------------------------------------

--
-- Estrutura para tabela `y63xg_action_logs`
--
-- Criação: 10/05/2020 às 14:27
-- Última atualização: 10/05/2020 às 14:27
--

CREATE TABLE `y63xg_action_logs` (
...
--
-- Despejando dados para a tabela `y63xg_action_logs`
--

INSERT INTO `y63xg_action_logs` (`id`, `message_language_key`, `message`, `log_date`, `extension`, `user_id`, `item_id`, `ip_address`) VALUES
(1, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_IN', '{\"action\":\"login\",\"userid\":\"673\",\"username\":\"admin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=673\",\"app\":\"PLG_ACTIONLOG_JOOMLA_APPLICATION_ADMINISTRATOR\"}', '2020-05-10 14:27:04', 'com_users', 673, 0, 'COM_ACTIONLOGS_DISABLED');

-- --------------------------------------------------------

--
-- Estrutura para tabela `y63xg_action_logs_extensions`
--
-- Criação: 10/05/2020 às 14:27
--

CREATE TABLE `y63xg_action_logs_extensions` (
  `id` int(10) UNSIGNED NOT NULL,
  `extension` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Despejando dados para a tabela `y63xg_action_logs_extensions`
--

INSERT INTO `y63xg_action_logs_extensions` (`id`, `extension`) VALUES
(1, 'com_banners'),
(2, 'com_cache'),
(3, 'com_categories'),
(4, 'com_config'),
...
--
-- Estrutura para tabela `y63xg_action_logs_users`
--
-- Criação: 10/05/2020 às 14:27
--

CREATE TABLE `y63xg_action_logs_users` (
...
--
-- Estrutura para tabela `y63xg_action_log_config`
--
-- Criação: 10/05/2020 às 14:27
--

CREATE TABLE `y63xg_action_log_config` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Despejando dados para a tabela `y63xg_action_log_config`
--

INSERT INTO `y63xg_action_log_config` (`id`, `type_title`, `type_alias`, `id_holder`, `title_holder`, `table_name`, `text_prefix`) VALUES
...
--
-- Estrutura para tabela `y63xg_assets`
--
-- Criação: 10/05/2020 às 11:22
-- Última atualização: 10/05/2020 às 14:27
--

CREATE TABLE `y63xg_assets` (
...
--
-- Despejando dados para a tabela `y63xg_assets`
--

INSERT INTO `y63xg_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(60, 11, 26, 27, 2, 'com_languages.language.2', 'Português do Brasil (pt-BR)', '{}'),
(61, 1, 115, 116, 1, 'com_fields', 'com_fields', '{}'),
(62, 1, 117, 118, 1, 'com_associations', 'com_associations', '{}');

-- --------------------------------------------------------

--
-- Estrutura para tabela `y63xg_associations`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_associations` (
...
--
-- Estrutura para tabela `y63xg_banners`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_banners` (
  `id` int(11) NOT NULL,
...
--
-- Estrutura para tabela `y63xg_banner_clients`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_banner_clients` (
  `id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Estrutura para tabela `y63xg_banner_tracks`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_banner_tracks` (
...
--
-- Estrutura para tabela `y63xg_categories`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_categories` (
  `id` int(11) NOT NULL,
...
--
-- Despejando dados para a tabela `y63xg_categories`
--

INSERT INTO `y63xg_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 11, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '{}', 673, '2020-05-10 14:16:55', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 673, '2020-05-10 14:16:55', 0, '0000-00-00 00:00:00', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 673, '2020-05-10 14:16:55', 0, '0000-00-00 00:00:00', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 673, '2020-05-10 14:16:55', 0, '0000-00-00 00:00:00', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 673, '2020-05-10 14:16:55', 0, '0000-00-00 00:00:00', 0, '*', 1),
(7, 32, 1, 9, 10, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 673, '2020-05-10 14:16:55', 0, '0000-00-00 00:00:00', 0, '*', 1);

-- --------------------------------------------------------

--
-- Estrutura para tabela `y63xg_contact_details`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_contact_details` (
  `id` int(11) NOT NULL,
...
--
-- Estrutura para tabela `y63xg_content`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_content` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `alias` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
--
-- Estrutura para tabela `y63xg_contentitem_tag_map`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_contentitem_tag_map` (
  `type_alias` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Estrutura para tabela `y63xg_content_frontpage`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_content_frontpage` (
...
--
-- Estrutura para tabela `y63xg_content_rating`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Estrutura para tabela `y63xg_content_types`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_content_types` (
...
--
-- Despejando dados para a tabela `y63xg_content_types`
--

INSERT INTO `y63xg_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Estrutura para tabela `y63xg_core_log_searches`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_core_log_searches` (
...
--
-- Estrutura para tabela `y63xg_extensions`
--
-- Criação: 10/05/2020 às 11:22
-- Última atualização: 10/05/2020 às 14:27
--

CREATE TABLE `y63xg_extensions` (
...
--
-- Despejando dados para a tabela `y63xg_extensions`
--

INSERT INTO `y63xg_extensions` (`extension_id`, `package_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(11, 0, 'com_languages', 'component', 'com_languages', '', 1, 1, 1, 1, '{\"name\":\"com_languages\",\"type\":\"component\",\"creationDate\":\"April 2006\",\"author\":\"Joomla! Project\",\"copyright\":\"(C) 2005 - 2020 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"3.0.0\",\"description\":\"COM_LANGUAGES_XML_DESCRIPTION\",\"group\":\"\"}', '{\"administrator\":\"pt-BR\",\"site\":\"pt-BR\"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(103, 0, 'LIB_JOOMLA', 'library', 'joomla', '', 0, 1, 1, 1, '{\"name\":\"LIB_JOOMLA\",\"type\":\"library\",\"creationDate\":\"2008\",\"author\":\"Joomla! Project\",\"copyright\":\"Copyright (C) 2005 - 2020 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"https:\\/\\/www.joomla.org\",\"version\":\"13.1\",\"description\":\"LIB_JOOMLA_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"joomla\"}', '{\"mediaversion\":\"4e1829de4f79ef96c6809dbf86bce60f\"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(452, 0, 'plg_system_updatenotification', 'plugin', 'updatenotification', 'system', 0, 1, 1, 0, '{\"name\":\"plg_system_updatenotification\",\"type\":\"plugin\",\"creationDate\":\"May 2015\",\"author\":\"Joomla! Project\",\"copyright\":\"Copyright (C) 2005 - 2020 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"3.5.0\",\"description\":\"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"updatenotification\"}', '{\"lastrun\":1589120816}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(454, 0, 'plg_system_stats', 'plugin', 'stats', 'system', 0, 1, 1, 0, '{\"name\":\"plg_system_stats\",\"type\":\"plugin\",\"creationDate\":\"November 2013\",\"author\":\"Joomla! Project\",\"copyright\":\"Copyright (C) 2005 - 2020 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"3.5.0\",\"description\":\"PLG_SYSTEM_STATS_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"stats\"}', '{\"mode\":3,\"lastrun\":\"\",\"unique_id\":\"50d54adfdaba584bf970601f958eab0f2ecebb73\",\"interval\":12}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Estrutura para tabela `y63xg_fields`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_fields` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Estrutura para tabela `y63xg_fields_categories`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_fields_categories` (
...
--
-- Estrutura para tabela `y63xg_fields_groups`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_fields_groups` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `context` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Estrutura para tabela `y63xg_fields_values`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_fields_values` (
...
--
-- Estrutura para tabela `y63xg_finder_filters`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_finder_filters` (
...
--
-- Estrutura para tabela `y63xg_finder_links`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_finder_links` (
...
--
-- Estrutura para tabela `y63xg_finder_links_terms0`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_finder_links_terms0` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Estrutura para tabela `y63xg_finder_links_terms1`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_finder_links_terms1` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estrutura para tabela `y63xg_finder_links_terms2`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_finder_links_terms2` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estrutura para tabela `y63xg_finder_links_terms3`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_finder_links_terms3` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estrutura para tabela `y63xg_finder_links_terms4`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_finder_links_terms4` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estrutura para tabela `y63xg_finder_links_terms5`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_finder_links_terms5` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estrutura para tabela `y63xg_finder_links_terms6`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_finder_links_terms6` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estrutura para tabela `y63xg_finder_links_terms7`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_finder_links_terms7` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estrutura para tabela `y63xg_finder_links_terms8`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_finder_links_terms8` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estrutura para tabela `y63xg_finder_links_terms9`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_finder_links_terms9` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estrutura para tabela `y63xg_finder_links_termsa`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_finder_links_termsa` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estrutura para tabela `y63xg_finder_links_termsb`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_finder_links_termsb` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estrutura para tabela `y63xg_finder_links_termsc`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_finder_links_termsc` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estrutura para tabela `y63xg_finder_links_termsd`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_finder_links_termsd` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estrutura para tabela `y63xg_finder_links_termse`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_finder_links_termse` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estrutura para tabela `y63xg_finder_links_termsf`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_finder_links_termsf` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estrutura para tabela `y63xg_finder_taxonomy`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_finder_taxonomy` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Despejando dados para a tabela `y63xg_finder_taxonomy`
--

INSERT INTO `y63xg_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Estrutura para tabela `y63xg_finder_taxonomy_map`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_finder_taxonomy_map` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Estrutura para tabela `y63xg_finder_terms`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_finder_terms` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Estrutura para tabela `y63xg_finder_terms_common`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_finder_terms_common` (
  `term` varchar(75) NOT NULL,
  `language` varchar(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Despejando dados para a tabela `y63xg_finder_terms_common`
--

INSERT INTO `y63xg_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Estrutura para tabela `y63xg_finder_tokens`
--
-- Criação: 10/05/2020 às 14:30
--

CREATE TABLE `y63xg_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
  `phrase` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Estrutura para tabela `y63xg_finder_tokens_aggregate`
--
-- Criação: 10/05/2020 às 14:30
--

CREATE TABLE `y63xg_finder_tokens_aggregate` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Estrutura para tabela `y63xg_finder_types`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_finder_types` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Estrutura para tabela `y63xg_languages`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_languages` (
...
--
-- Despejando dados para a tabela `y63xg_languages`
--

INSERT INTO `y63xg_languages` (`lang_id`, `asset_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
...
--
-- Estrutura para tabela `y63xg_menu`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_menu` (
  `id` int(11) NOT NULL,
...
--
-- Despejando dados para a tabela `y63xg_menu`
--

INSERT INTO `y63xg_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Estrutura para tabela `y63xg_menu_types`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_menu_types` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Despejando dados para a tabela `y63xg_menu_types`
--

INSERT INTO `y63xg_menu_types` (`id`, `asset_id`, `menutype`, `title`, `description`, `client_id`) VALUES
(1, 0, 'mainmenu', 'Main Menu', 'The main menu for the site', 0);

-- --------------------------------------------------------

--
-- Estrutura para tabela `y63xg_messages`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_messages` (
...
--
-- Estrutura para tabela `y63xg_messages_cfg`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_messages_cfg` (
...
--
-- Estrutura para tabela `y63xg_modules`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_modules` (
  `id` int(11) NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Despejando dados para a tabela `y63xg_modules`
--

INSERT INTO `y63xg_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Estrutura para tabela `y63xg_modules_menu`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT '0',
  `menuid` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Despejando dados para a tabela `y63xg_modules_menu`
--

INSERT INTO `y63xg_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Estrutura para tabela `y63xg_newsfeeds`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Estrutura para tabela `y63xg_overrider`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_overrider` (
...
--
-- Estrutura para tabela `y63xg_postinstall_messages`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_postinstall_messages` (
...
--
-- Despejando dados para a tabela `y63xg_postinstall_messages`
--

INSERT INTO `y63xg_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Estrutura para tabela `y63xg_privacy_consents`
--
-- Criação: 10/05/2020 às 14:27
--

CREATE TABLE `y63xg_privacy_consents` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Estrutura para tabela `y63xg_privacy_requests`
--
-- Criação: 10/05/2020 às 14:27
--

CREATE TABLE `y63xg_privacy_requests` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Estrutura para tabela `y63xg_redirect_links`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_redirect_links` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Estrutura para tabela `y63xg_schemas`
--
-- Criação: 10/05/2020 às 11:22
-- Última atualização: 10/05/2020 às 14:27
--

CREATE TABLE `y63xg_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Despejando dados para a tabela `y63xg_schemas`
--

INSERT INTO `y63xg_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.9.16-2020-03-04');

-- --------------------------------------------------------

--
-- Estrutura para tabela `y63xg_session`
--
-- Criação: 10/05/2020 às 11:22
-- Última atualização: 10/05/2020 às 14:27
--

CREATE TABLE `y63xg_session` (
...
--
-- Despejando dados para a tabela `y63xg_session`
--

INSERT INTO `y63xg_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
(0x6532623264623864663733316235643361303664326465356561323634313338, 1, 0, 1589120865, 'joomla|s:1084:\"\";', 673, 'admin');

-- --------------------------------------------------------

--
-- Estrutura para tabela `y63xg_tags`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_tags` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Despejando dados para a tabela `y63xg_tags`
--

INSERT INTO `y63xg_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 673, '2020-05-10 14:16:55', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Estrutura para tabela `y63xg_template_styles`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_template_styles` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Despejando dados para a tabela `y63xg_template_styles`
--

INSERT INTO `y63xg_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Estrutura para tabela `y63xg_ucm_base`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_ucm_base` (
...
--
-- Estrutura para tabela `y63xg_ucm_content`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_ucm_content` (
...
--
-- Estrutura para tabela `y63xg_ucm_history`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_ucm_history` (
...
--
-- Estrutura para tabela `y63xg_updates`
--
-- Criação: 10/05/2020 às 11:22
-- Última atualização: 10/05/2020 às 14:27
--

CREATE TABLE `y63xg_updates` (
...
--
-- Despejando dados para a tabela `y63xg_updates`
--

INSERT INTO `y63xg_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`, `extra_query`) VALUES
...
(34, 2, 0, 'Persian', '', 'pkg_fa-IR', 'package', '', 0, '3.9.18.1', '', 'https://update.joomla.org/language/details3/fa-IR_details.xml', '', ''),
...
(46, 2, 0, 'Ukrainian', '', 'pkg_uk-UA', 'package', '', 0, '3.9.18.7', '', 'https://update.joomla.org/language/details3/uk-UA_details.xml', '', ''),
...
(55, 2, 0, 'Bosnian', '', 'pkg_bs-BA', 'package', '', 0, '3.9.18.1', '', 'https://update.joomla.org/language/details3/bs-BA_details.xml', '', ''),
...
--
-- Estrutura para tabela `y63xg_update_sites`
--
-- Criação: 10/05/2020 às 11:22
-- Última atualização: 10/05/2020 às 14:27
--

CREATE TABLE `y63xg_update_sites` (
...
--
-- Despejando dados para a tabela `y63xg_update_sites`
--

INSERT INTO `y63xg_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 1589120817, ''),
(2, 'Accredited Joomla! Translations', 'collection', 'https://update.joomla.org/language/translationlist_3.xml', 1, 1589120221, ''),
(3, 'Joomla! Update Component Update Site', 'extension', 'https://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 1589120860, '');

-- --------------------------------------------------------

--
-- Estrutura para tabela `y63xg_update_sites_extensions`
--
-- Criação: 10/05/2020 às 14:27
--

CREATE TABLE `y63xg_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT '0',
  `extension_id` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Links extensions to update sites';

--
-- Despejando dados para a tabela `y63xg_update_sites_extensions`
--

INSERT INTO `y63xg_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 802),
(2, 10002),
(3, 28);
...
--
-- Estrutura para tabela `y63xg_usergroups`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_usergroups` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
...
--
-- Despejando dados para a tabela `y63xg_usergroups`
--

INSERT INTO `y63xg_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Estrutura para tabela `y63xg_users`
--
-- Criação: 10/05/2020 às 11:22
-- Última atualização: 10/05/2020 às 14:27
--

CREATE TABLE `y63xg_users` (
  `id` int(11) NOT NULL,
...
--
-- Despejando dados para a tabela `y63xg_users`
--

INSERT INTO `y63xg_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(673, 'Super User', 'admin', 'admin@email.com', '$2y$10$k.TybFVWsKawGlLiIrR98Ou.rCM7L/IFIpgVzRDFq6vX031Sg3j2e', 0, 1, '2020-05-10 14:16:56', '2020-05-10 14:27:04', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Estrutura para tabela `y63xg_user_keys`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_user_keys` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Estrutura para tabela `y63xg_user_notes`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_user_notes` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `catid` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Estrutura para tabela `y63xg_user_profiles`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_user_profiles` (
...
--
-- Estrutura para tabela `y63xg_user_usergroup_map`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_user_usergroup_map` (
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__usergroups.id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Despejando dados para a tabela `y63xg_user_usergroup_map`
--

INSERT INTO `y63xg_user_usergroup_map` (`user_id`, `group_id`) VALUES
(673, 8);

-- --------------------------------------------------------

--
-- Estrutura para tabela `y63xg_utf8_conversion`
--
-- Criação: 10/05/2020 às 11:22
-- Última atualização: 10/05/2020 às 14:27
--

CREATE TABLE `y63xg_utf8_conversion` (
  `converted` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Despejando dados para a tabela `y63xg_utf8_conversion`
--

INSERT INTO `y63xg_utf8_conversion` (`converted`) VALUES
(4);

-- --------------------------------------------------------

--
-- Estrutura para tabela `y63xg_viewlevels`
--
-- Criação: 10/05/2020 às 11:22
--

CREATE TABLE `y63xg_viewlevels` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
  `title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded access control.'
...
--
-- Despejando dados para a tabela `y63xg_viewlevels`
--

INSERT INTO `y63xg_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Índices de tabela `y63xg_action_logs`
--
ALTER TABLE `y63xg_action_logs`
  ADD PRIMARY KEY (`id`),
...
--
-- Índices de tabela `y63xg_action_logs_extensions`
--
ALTER TABLE `y63xg_action_logs_extensions`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `y63xg_action_logs_users`
--
ALTER TABLE `y63xg_action_logs_users`
  ADD PRIMARY KEY (`user_id`),
  ADD KEY `idx_notify` (`notify`);

--
-- Índices de tabela `y63xg_action_log_config`
--
ALTER TABLE `y63xg_action_log_config`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `y63xg_assets`
--
ALTER TABLE `y63xg_assets`
  ADD PRIMARY KEY (`id`),
...
--
-- Índices de tabela `y63xg_associations`
--
ALTER TABLE `y63xg_associations`
  ADD PRIMARY KEY (`context`,`id`),
  ADD KEY `idx_key` (`key`);

--
-- Índices de tabela `y63xg_banners`
--
ALTER TABLE `y63xg_banners`
  ADD PRIMARY KEY (`id`),
...
--
-- Índices de tabela `y63xg_banner_clients`
--
ALTER TABLE `y63xg_banner_clients`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_own_prefix` (`own_prefix`),
  ADD KEY `idx_metakey_prefix` (`metakey_prefix`(100));

--
-- Índices de tabela `y63xg_banner_tracks`
--
ALTER TABLE `y63xg_banner_tracks`
...
--
-- Índices de tabela `y63xg_categories`
--
ALTER TABLE `y63xg_categories`
  ADD PRIMARY KEY (`id`),
...
--
-- Índices de tabela `y63xg_contact_details`
--
ALTER TABLE `y63xg_contact_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
...
--
-- Índices de tabela `y63xg_content`
--
ALTER TABLE `y63xg_content`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Índices de tabela `y63xg_contentitem_tag_map`
--
ALTER TABLE `y63xg_contentitem_tag_map`
...
--
-- Índices de tabela `y63xg_content_frontpage`
--
ALTER TABLE `y63xg_content_frontpage`
  ADD PRIMARY KEY (`content_id`);

--
-- Índices de tabela `y63xg_content_rating`
--
ALTER TABLE `y63xg_content_rating`
  ADD PRIMARY KEY (`content_id`);

--
-- Índices de tabela `y63xg_content_types`
--
ALTER TABLE `y63xg_content_types`
  ADD PRIMARY KEY (`type_id`),
  ADD KEY `idx_alias` (`type_alias`(100));

--
-- Índices de tabela `y63xg_extensions`
--
ALTER TABLE `y63xg_extensions`
...
--
-- Índices de tabela `y63xg_fields`
--
ALTER TABLE `y63xg_fields`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Índices de tabela `y63xg_fields_categories`
--
ALTER TABLE `y63xg_fields_categories`
  ADD PRIMARY KEY (`field_id`,`category_id`);

--
-- Índices de tabela `y63xg_fields_groups`
--
ALTER TABLE `y63xg_fields_groups`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Índices de tabela `y63xg_fields_values`
--
ALTER TABLE `y63xg_fields_values`
  ADD KEY `idx_field_id` (`field_id`),
  ADD KEY `idx_item_id` (`item_id`(191));

--
-- Índices de tabela `y63xg_finder_filters`
--
ALTER TABLE `y63xg_finder_filters`
  ADD PRIMARY KEY (`filter_id`);

--
-- Índices de tabela `y63xg_finder_links`
--
ALTER TABLE `y63xg_finder_links`
...
--
-- Índices de tabela `y63xg_finder_links_terms0`
--
ALTER TABLE `y63xg_finder_links_terms0`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Índices de tabela `y63xg_finder_links_terms1`
--
ALTER TABLE `y63xg_finder_links_terms1`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Índices de tabela `y63xg_finder_links_terms2`
--
ALTER TABLE `y63xg_finder_links_terms2`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Índices de tabela `y63xg_finder_links_terms3`
--
ALTER TABLE `y63xg_finder_links_terms3`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Índices de tabela `y63xg_finder_links_terms4`
--
ALTER TABLE `y63xg_finder_links_terms4`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Índices de tabela `y63xg_finder_links_terms5`
--
ALTER TABLE `y63xg_finder_links_terms5`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Índices de tabela `y63xg_finder_links_terms6`
--
ALTER TABLE `y63xg_finder_links_terms6`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Índices de tabela `y63xg_finder_links_terms7`
--
ALTER TABLE `y63xg_finder_links_terms7`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Índices de tabela `y63xg_finder_links_terms8`
--
ALTER TABLE `y63xg_finder_links_terms8`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Índices de tabela `y63xg_finder_links_terms9`
--
ALTER TABLE `y63xg_finder_links_terms9`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Índices de tabela `y63xg_finder_links_termsa`
--
ALTER TABLE `y63xg_finder_links_termsa`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Índices de tabela `y63xg_finder_links_termsb`
--
ALTER TABLE `y63xg_finder_links_termsb`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Índices de tabela `y63xg_finder_links_termsc`
--
ALTER TABLE `y63xg_finder_links_termsc`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Índices de tabela `y63xg_finder_links_termsd`
--
ALTER TABLE `y63xg_finder_links_termsd`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Índices de tabela `y63xg_finder_links_termse`
--
ALTER TABLE `y63xg_finder_links_termse`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Índices de tabela `y63xg_finder_links_termsf`
--
ALTER TABLE `y63xg_finder_links_termsf`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Índices de tabela `y63xg_finder_taxonomy`
--
ALTER TABLE `y63xg_finder_taxonomy`
  ADD PRIMARY KEY (`id`),
...
--
-- Índices de tabela `y63xg_finder_taxonomy_map`
--
ALTER TABLE `y63xg_finder_taxonomy_map`
  ADD PRIMARY KEY (`link_id`,`node_id`),
  ADD KEY `link_id` (`link_id`),
  ADD KEY `node_id` (`node_id`);

--
-- Índices de tabela `y63xg_finder_terms`
--
ALTER TABLE `y63xg_finder_terms`
...
--
-- Índices de tabela `y63xg_finder_terms_common`
--
ALTER TABLE `y63xg_finder_terms_common`
  ADD KEY `idx_word_lang` (`term`,`language`),
  ADD KEY `idx_lang` (`language`);

--
-- Índices de tabela `y63xg_finder_tokens`
--
ALTER TABLE `y63xg_finder_tokens`
  ADD KEY `idx_word` (`term`),
  ADD KEY `idx_context` (`context`);

--
-- Índices de tabela `y63xg_finder_tokens_aggregate`
--
ALTER TABLE `y63xg_finder_tokens_aggregate`
  ADD KEY `token` (`term`),
  ADD KEY `keyword_id` (`term_id`);

--
-- Índices de tabela `y63xg_finder_types`
--
ALTER TABLE `y63xg_finder_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `title` (`title`);

--
-- Índices de tabela `y63xg_languages`
--
ALTER TABLE `y63xg_languages`
...
--
-- Índices de tabela `y63xg_menu`
--
ALTER TABLE `y63xg_menu`
  ADD PRIMARY KEY (`id`),
...
--
-- Índices de tabela `y63xg_menu_types`
--
ALTER TABLE `y63xg_menu_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_menutype` (`menutype`);

--
-- Índices de tabela `y63xg_messages`
--
ALTER TABLE `y63xg_messages`
  ADD PRIMARY KEY (`message_id`),
  ADD KEY `useridto_state` (`user_id_to`,`state`);

--
-- Índices de tabela `y63xg_messages_cfg`
--
ALTER TABLE `y63xg_messages_cfg`
  ADD UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`);

--
-- Índices de tabela `y63xg_modules`
--
ALTER TABLE `y63xg_modules`
  ADD PRIMARY KEY (`id`),
...
--
-- Índices de tabela `y63xg_modules_menu`
--
ALTER TABLE `y63xg_modules_menu`
  ADD PRIMARY KEY (`moduleid`,`menuid`);

--
-- Índices de tabela `y63xg_newsfeeds`
--
ALTER TABLE `y63xg_newsfeeds`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`published`),
...
--
-- Índices de tabela `y63xg_overrider`
--
ALTER TABLE `y63xg_overrider`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `y63xg_postinstall_messages`
--
ALTER TABLE `y63xg_postinstall_messages`
  ADD PRIMARY KEY (`postinstall_message_id`);

--
-- Índices de tabela `y63xg_privacy_consents`
--
ALTER TABLE `y63xg_privacy_consents`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`);

--
-- Índices de tabela `y63xg_privacy_requests`
--
ALTER TABLE `y63xg_privacy_requests`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `y63xg_redirect_links`
--
ALTER TABLE `y63xg_redirect_links`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_old_url` (`old_url`(100)),
  ADD KEY `idx_link_modifed` (`modified_date`);

--
-- Índices de tabela `y63xg_schemas`
--
ALTER TABLE `y63xg_schemas`
  ADD PRIMARY KEY (`extension_id`,`version_id`);

--
-- Índices de tabela `y63xg_session`
--
ALTER TABLE `y63xg_session`
...
--
-- Índices de tabela `y63xg_tags`
--
ALTER TABLE `y63xg_tags`
  ADD PRIMARY KEY (`id`),
...
--
-- Índices de tabela `y63xg_template_styles`
--
ALTER TABLE `y63xg_template_styles`
  ADD PRIMARY KEY (`id`),
...
--
-- Índices de tabela `y63xg_ucm_base`
--
ALTER TABLE `y63xg_ucm_base`
...
--
-- Índices de tabela `y63xg_ucm_content`
--
ALTER TABLE `y63xg_ucm_content`
...
--
-- Índices de tabela `y63xg_ucm_history`
--
ALTER TABLE `y63xg_ucm_history`
  ADD PRIMARY KEY (`version_id`),
  ADD KEY `idx_ucm_item_id` (`ucm_type_id`,`ucm_item_id`),
  ADD KEY `idx_save_date` (`save_date`);

--
-- Índices de tabela `y63xg_updates`
--
ALTER TABLE `y63xg_updates`
  ADD PRIMARY KEY (`update_id`);

--
-- Índices de tabela `y63xg_update_sites`
--
ALTER TABLE `y63xg_update_sites`
  ADD PRIMARY KEY (`update_site_id`);

--
-- Índices de tabela `y63xg_update_sites_extensions`
--
ALTER TABLE `y63xg_update_sites_extensions`
  ADD PRIMARY KEY (`update_site_id`,`extension_id`);

--
-- Índices de tabela `y63xg_usergroups`
--
ALTER TABLE `y63xg_usergroups`
  ADD PRIMARY KEY (`id`),
...
--
-- Índices de tabela `y63xg_users`
--
ALTER TABLE `y63xg_users`
  ADD PRIMARY KEY (`id`),
...
--
-- Índices de tabela `y63xg_user_keys`
--
ALTER TABLE `y63xg_user_keys`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `series` (`series`),
  ADD KEY `user_id` (`user_id`);

--
-- Índices de tabela `y63xg_user_notes`
--
ALTER TABLE `y63xg_user_notes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`),
  ADD KEY `idx_category_id` (`catid`);

--
-- Índices de tabela `y63xg_user_profiles`
--
ALTER TABLE `y63xg_user_profiles`
  ADD UNIQUE KEY `idx_user_id_profile_key` (`user_id`,`profile_key`);

--
-- Índices de tabela `y63xg_user_usergroup_map`
--
ALTER TABLE `y63xg_user_usergroup_map`
  ADD PRIMARY KEY (`user_id`,`group_id`);

--
-- Índices de tabela `y63xg_viewlevels`
--
ALTER TABLE `y63xg_viewlevels`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT de tabela `y63xg_action_logs`
--
ALTER TABLE `y63xg_action_logs`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de tabela `y63xg_action_logs_extensions`
--
ALTER TABLE `y63xg_action_logs_extensions`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT de tabela `y63xg_action_log_config`
--
ALTER TABLE `y63xg_action_log_config`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT de tabela `y63xg_assets`
--
ALTER TABLE `y63xg_assets`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=63;

--
-- AUTO_INCREMENT de tabela `y63xg_banners`
--
ALTER TABLE `y63xg_banners`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `y63xg_banner_clients`
--
ALTER TABLE `y63xg_banner_clients`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `y63xg_categories`
--
ALTER TABLE `y63xg_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de tabela `y63xg_contact_details`
--
ALTER TABLE `y63xg_contact_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `y63xg_content`
--
ALTER TABLE `y63xg_content`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `y63xg_content_types`
--
ALTER TABLE `y63xg_content_types`
  MODIFY `type_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT de tabela `y63xg_extensions`
--
ALTER TABLE `y63xg_extensions`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10003;

--
-- AUTO_INCREMENT de tabela `y63xg_fields`
--
ALTER TABLE `y63xg_fields`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `y63xg_fields_groups`
--
ALTER TABLE `y63xg_fields_groups`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `y63xg_finder_filters`
--
ALTER TABLE `y63xg_finder_filters`
  MODIFY `filter_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `y63xg_finder_links`
--
ALTER TABLE `y63xg_finder_links`
  MODIFY `link_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `y63xg_finder_taxonomy`
--
ALTER TABLE `y63xg_finder_taxonomy`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de tabela `y63xg_finder_terms`
--
ALTER TABLE `y63xg_finder_terms`
  MODIFY `term_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `y63xg_finder_types`
--
ALTER TABLE `y63xg_finder_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `y63xg_languages`
--
ALTER TABLE `y63xg_languages`
  MODIFY `lang_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de tabela `y63xg_menu`
--
ALTER TABLE `y63xg_menu`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=102;

--
-- AUTO_INCREMENT de tabela `y63xg_menu_types`
--
ALTER TABLE `y63xg_menu_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de tabela `y63xg_messages`
--
ALTER TABLE `y63xg_messages`
  MODIFY `message_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `y63xg_modules`
--
ALTER TABLE `y63xg_modules`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;

--
-- AUTO_INCREMENT de tabela `y63xg_newsfeeds`
--
ALTER TABLE `y63xg_newsfeeds`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `y63xg_overrider`
--
ALTER TABLE `y63xg_overrider`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key';

--
-- AUTO_INCREMENT de tabela `y63xg_postinstall_messages`
--
ALTER TABLE `y63xg_postinstall_messages`
  MODIFY `postinstall_message_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de tabela `y63xg_privacy_consents`
--
ALTER TABLE `y63xg_privacy_consents`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `y63xg_privacy_requests`
--
ALTER TABLE `y63xg_privacy_requests`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `y63xg_redirect_links`
--
ALTER TABLE `y63xg_redirect_links`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `y63xg_tags`
--
ALTER TABLE `y63xg_tags`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de tabela `y63xg_template_styles`
--
ALTER TABLE `y63xg_template_styles`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de tabela `y63xg_ucm_content`
--
ALTER TABLE `y63xg_ucm_content`
  MODIFY `core_content_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `y63xg_ucm_history`
--
ALTER TABLE `y63xg_ucm_history`
  MODIFY `version_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `y63xg_updates`
--
ALTER TABLE `y63xg_updates`
  MODIFY `update_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=79;

--
-- AUTO_INCREMENT de tabela `y63xg_update_sites`
--
ALTER TABLE `y63xg_update_sites`
  MODIFY `update_site_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de tabela `y63xg_usergroups`
--
ALTER TABLE `y63xg_usergroups`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de tabela `y63xg_users`
--
ALTER TABLE `y63xg_users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=674;

--
-- AUTO_INCREMENT de tabela `y63xg_user_keys`
--
ALTER TABLE `y63xg_user_keys`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `y63xg_user_notes`
--
ALTER TABLE `y63xg_user_notes`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `y63xg_viewlevels`
--
ALTER TABLE `y63xg_viewlevels`
