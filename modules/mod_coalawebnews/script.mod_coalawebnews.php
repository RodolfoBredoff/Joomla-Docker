...
class mod_coalawebnewsInstallerScript
{
     ...
     */
    private $coalaweb_extension = 'mod_coalawebnews';
    ...
    private $update_remove = array(
        'http://cdn.coalaweb.com/updates/cw-news-core.xml',
        'http://cdn.coalaweb.com/updates/cw-news-pro.xml',
        'https://coalaweb.com/index.php?option=com_rdsubs&view=updater&format=xml&cat=3&type=.xml',
    );
    ...
    private $removeFiles = array(
        'files' => array('modules/mod_coalawebnews/tmpl/compact-circle.php','modules/mod_coalawebnews/tmpl/compact-square.php','modules/mod_coalawebnews/tmpl/header.php','modules/mod_coalawebnews/script.coalawebnews.php'
        ),
        'folders' => array('modules/mod_coalawebnews/tmpl/compact-circle','modules/mod_coalawebnews/tmpl/compact-square','modules/mod_coalawebnews/tmpl/header','modules/mod_coalawebnews/modules','modules/mod_coalawebnews/plugins','modules/mod_coalawebnews/modules','modules/mod_coalawebnews/plugins'
        )
    );
     ...
     */
    private $oldPluginNames = array('cwgears'
    );
    ...
    private function renderPostInstallation($status, $parent, $type)
    {
        ...
        <div class="well well-lg">
            <h3><?php echo JText::_('MOD_CWNEWS_POST_INSTALL_TITLE'); ?></h3>
            <?php if ($type == 'update') : ?>
                
            <?php endif; ?>
            <div class="alert alert-danger">
                <span class="icon-notification"></span>
                <?php echo JText::_('MOD_CWNEWS_POST_INSTALL_MSG'); ?>
            </div>
            <?php if ($status->gears) : ?>
                <div class="alert alert-danger">
                    <span class="icon-notification"></span>
                    <?php echo JText::_('MOD_CWNEWS_GEARS_CURRENT_NEWER_MSG'); ?>
                </div>
            <?php endif; ?>
            <h3><?php echo JText::_('MOD_CWNEWS_INSTALL_DETAILS_TITLE'); ?></h3>
            <table class="coalaweb">
                ...
                <tr class="row0">
                    <td class="key">
                        <?php echo JText::_('MOD_CWNEWS_TITLE_' . $typeUpper . ''); ?>
                    </td>
                    <td>
    ...
    private function renderPostUninstallation($status, $parent)
    {
        ...
        <div class="well well-lg">
            <h3><?php echo JText::_('MOD_CWNEWS_TITLE_' . $typeUpper . '') . ' - ' . JText::_('MOD_CWNEWS_UNINSTALL_STATUS_MSG') ?></h3>
            <table class="coalaweb">
                <thead align="left">
                <tr>
                    <th class="title" align="left">Main</th>
