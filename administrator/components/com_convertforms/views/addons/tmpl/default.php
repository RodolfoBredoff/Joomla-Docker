                            ...
                            <div class="cf-addon-action text-center">
                               ...
                               <?php 
                                ...
                                <?php if (!$item['comingsoon'] && $item['extensionid']) { ?>
                                    ...
                                    <?php 
                                        $optionsURL = 'index.php?option=com_plugins&task=plugin.edit&layout=modal&tmpl=component&extension_id=' . $item['extensionid'];
                                ...
                                <?php 
                                    $docsURL = 'http://www.tassos.gr/joomla-extensions/convert-forms//docs/' . $item['docalias'];
                                ?>
