...
if (isset($component['settings']['icon-background-color']) && $component['settings']['icon-background-color'] != '')
{
    $styleCanvas[] = ".off-canvas-{$position} .toggle-offcanvas {";
    $styleCanvas[] = "background: {$component['settings']['icon-background-color']};";
    $styleCanvas[] = "border-color: {$component['settings']['icon-background-color']};";
    $styleCanvas[] = '}';
}
...
switch ($position)
{
	case 'top':
		...
		if (isset($component['settings']['icon']) && $component['settings']['icon'] != '')
		{
		    $defaultIcon = 'fa ' . $component['settings']['icon'];
		}
...
?>
<div class="<?php echo SunFwSiteBootstrap::showOn($visible_in) . ' ' . implode(' ', $container_class); ?>">
	<?php //if ( ! array_key_exists('show-toggle', $component['settings']) || intval($component['settings']['show-toggle']) ) : ?>
	<a class="<?php echo $anchor_class; ?>" href="#">
        <i class="<?php echo $defaultIcon; ?>" aria-hidden="true"></i>
    </a>
