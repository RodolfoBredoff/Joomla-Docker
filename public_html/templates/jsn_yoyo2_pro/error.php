...
<head>
    ...
    <link href="<?php echo $this->baseurl; ?>/plugins/system/sunfw/assets/3rd-party/font-awesome/css/font-awesome.min.css" rel="stylesheet" />
...
<body class="sunfw-error-page site <?php echo $option
    . ' view-' . $view
