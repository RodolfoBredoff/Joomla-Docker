...
class plgSystemCwgearsInstallerScript
{
     ...
     */
    private $coalaweb_extension = 'plg_system_cwgears';
    ...
    private $update_remove = array(
        'http://cdn.coalaweb.com/updates/cw-gears-core.xml',
        'http://cdn.coalaweb.com/updates/cw-gears-pro.xml',
